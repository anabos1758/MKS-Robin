...
#define STRING_CONFIG_H_AUTHOR "(ADIM GAntry-S, ABOSCO)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "MKS Robin Lite" // will be shown during bootup in line 1
